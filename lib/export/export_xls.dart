class XMLvariables{
  ...
  static abrirTabla(String expandedColumnCount){
    //Hacer una consulta a la base de datos
    //para obtener la cantidad de pesadas guardadas
    int rows = 0;
    // al valor obtenido de la consulta guardarlo en rows, y sumarle 5 despues


    rows += 5;
    final String abrirTabla = "<Table ss:ExpandedColumnCount=\"$expandedColumnCount\" ss:ExpandedRowCount=\"$rows\" x:FullColumns=\"1\"\n" 
    "   x:FullRows=\"1\" ss:DefaultColumnWidth=\"81.75\" ss:DefaultRowHeight=\"15\">\n";
    return abrirTabla;
  }

  static crearEncabezado(List<String> nombres, String titulo){
    String campos ='';
    ...
    "    <Cell ss:MergeAcross=\"7\" ss:MergeDown=\"3\" ss:StyleID=\"s100\"><Data\n"
    "      ss:Type=\"String\">$titulo</Data></Cell>\n"
  ...
  static cerrarHoja(String range){
    ...
    "  <Pane>\n  "
    "   <Number>3</Number>\n  "
    "   <RangeSelection>R5C1:R5C$range</RangeSelection>\n  "
    "  </Pane>\n  "
    " </Panes>\n  "
